...
export const API_ENDPOINTS = {
  ...
  ADMIN_SUPPORT: {
    ...
    CATEGORIES: `${API_BASE_URL}/api/v1/admin/support-tickets/categories`,
    CREATE: `${API_BASE_URL}/api/v1/admin/support-tickets`,
    DETAIL: (id: string) => `${API_BASE_URL}/api/v1/admin/support-tickets/${id}`,
    ASSIGN: (id: string) => `${API_BASE_URL}/api/v1/admin/support-tickets/${id}/assign`,
    UPDATE_STATUS: (id: string) => `${API_BASE_URL}/api/v1/admin/support-tickets/${id}/status`,
    MESSAGES: (id: string) => `${API_BASE_URL}/api/v1/admin/support-tickets/${id}/messages`,
    TICKET_HISTORY: (id: string) => `${API_BASE_URL}/api/v1/admin/support-tickets/${id}/history`,
    REPORTS: `${API_BASE_URL}/api/v1/admin/support-tickets/stats`,
    AUDIT: `${API_BASE_URL}/api/v1/admin/support-tickets/audit/history`,
  },
  ADMIN_VERIFICATION: {

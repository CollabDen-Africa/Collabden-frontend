                    ...
                    <div className="flex flex-col items-center gap-[40px] w-full">
                        ...
                        <div className="flex flex-col items-center gap-[16px]">
                            <h1 className="text-[32px] leading-[40px] font-semibold text-black text-center">
                                Share Your Sound Without Losing Its Quality
                            </h1>
                            <p className="text-[18px] leading-[28px] font-medium text-[#434C4F] text-center">
                                Upload and send your tracks in their original quality, so every detail sounds exactly the way you created it.
                            </p>
                        </div>

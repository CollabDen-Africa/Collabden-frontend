  ...
  return (
    <div className="flex flex-col w-full flex-1 gap-8.75 animate-in fade-in duration-300 pb-10">
      ...
      <div className="w-full bg-white/10 border border-white/10 rounded-[35px] flex flex-col backdrop-blur-md overflow-hidden">
        ...
        {/* Open to Collaborate Row */}
        <div className="px-8.75 py-7.25 border-b-[1.6px] border-white/5 flex flex-row items-center justify-between gap-6">
          <div className="flex flex-col gap-0.75">
            ...
            <span className="font-raleway font-normal text-[17.6px] text-text-muted">
              Show others you&apos;re available for new projects
            </span>
          </div>
          <Toggle 
        ...
        {/* Who Can Message Me Row */}
        <div className="px-8.75 py-7.25 border-b-[1.6px] border-white/5 flex flex-col gap-4.5">
              ...
              <button
                ...
                className={`flex items-center justify-center px-4.5 py-3 rounded-[23.4px] border-[1.6px] font-raleway font-medium text-[17.6px] transition-all duration-200 ${
                  whoCanMessage === option
                    ? "bg-primary-green border-white/10 text-white"
                    : "bg-white/20 border-white/10 text-white/50 hover:bg-white/30"
                }`}
              >
                {option}
              </button>
        ...
        {/* Data Export Row */}
        <div className="px-8.75 py-7.25 flex flex-col gap-4.5">
          ...
          <Button 
            variant="ghost" 
            className="w-fit rounded-[23.4px] px-6 py-3 h-auto border-[1.6px] border-white/10 text-text-muted hover:text-white hover:bg-white/5 gap-3"
          >
            <FiDownload size={20} />
            <span className="font-raleway font-medium text-[20.5px]">Download My Data</span>
          </Button>
        </div>
      </div>

      {/* Danger Zone Card */}
      <div className="w-full bg-white/10 border-[1.6px] border-border-muted/20 rounded-[35px] p-6 flex flex-col gap-4.5 backdrop-blur-md mt-4">
        ...
        <div className="w-full bg-white/5 border-[1.6px] border-border-muted/20 rounded-[23.4px] p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-start md:items-center gap-6">
            ...
            <div className="flex flex-col gap-0.75">
              ...
              <span className="font-inter font-normal text-[17.6px] text-accent-soft-blue">

...
const Navbar = () => {
    ...
    return (
        <nav ref={navRef} className="fixed top-6 left-1/2 -translate-x-1/2 w-[90%] max-w-7xl z-50">
                    ...
                    {isAuthenticated ? (
                        ...
                        <>
                            <button
                                ...
                                className="text-white/90 hover:text-white text-md font-semibold cursor-pointer bg-transparent border-none p-0 font-sans"
                            >
                                Log in
                            </button>
                            <Button 
                                ...
                                {isAuthenticated ? (
                                    ...
                                    <>
                                        <button
                                            ...
                                            className="text-white/90 text-lg font-semibold py-2 text-left bg-transparent border-none p-0 cursor-pointer font-sans"
                                        >
                                            Log in
                                        </button>
                                        <Button
            ...
            <UpcomingModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
        </nav>
    );
};
